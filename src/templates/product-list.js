...
class ProductIndex extends React.Component {
  render() {
    ...
    const prevPage =
      currentPage - 1 === 1 ? productSlug : productSlug + (currentPage - 1).toString()
    ...
    return (
      <Layout className="blog-page">
        <Seo
          title={"Product — Page " + currentPage + " of " + numPages}
          description={
            "Product page " + currentPage + " of " + numPages
          }
        />
        <h1>Products</h1>
